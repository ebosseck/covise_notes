...
\begin{messagetypes}
	...
	\messageType{QUIT}{34}{QUIT message from user interface, opencover or other sources. Handled by server, depending on parameters. Quits the current session}
	\messageType{START}{35}{}
	\messageType{COVISE_ERROR}{36}{Sent to all modules as \lstinline|COVISE_MESSAGE_COVISE_ERROR|. In case of error overflow, the info that there is overflow is sent instead}
	\messageType{INOBJ}{37}{}
	\messageType{OUTOBJ}{38}{}
	\messageType{OBJECT_NO_LONGER_USED}{39}{}
	\messageType{SET_ACCESS}{40}{}
	\messageType{FINALL}{41}{Module says it has finished. Server Side resources are released, and server sends \lstinline|COVISE_MESSAGE_UI| with parameter ''FINISHED $\backslash n$'' in case no modules are running anymore}
	\messageType{ADD_OBJECT}{42}{}
	\messageType{DELETE_OBJECT}{43}{}
	\messageType{NEW_OBJECT_VERSION}{44}{}
	\messageType{RENDER}{45}{Forwarded to all other renderers by the server}
	\messageType{WAIT_CONTACT}{46}{}
	\messageType{PARINFO}{47}{send message to all userinterfaces}
	...
	\messageType{WARNING}{55}{Messages are relayed as Error to all renderers. Data will be modified by prefix ''WARNING'' and suffix ''$\backslash n$''}
	\messageType{INFO}{56}{Messages are relayed as Error to all renderers. Data will be modified by prefix ''INFO'' and suffix ''$\backslash n$''}
	\messageType{REPLACE_OBJECT}{57}{}
	\messageType{PLOT}{58}{Forwarded to all other renderers by the server}
	...
	\messageType{REQ_UI}{67}{Relayed to all Userinterface types}
	...
	\messageType{COVISE_STOP_PIPELINE}{75}{Sets the status of the module with the name from the parameters to stopping}
	...
	\messageType{SOCKET_CLOSED}{84}{Should be ignored if send to the server (see src/sys/controller/handler.cpp, handleMsg, ln 246}
	...
	\messageType{CRB}{90}{}
	\messageType{GENERIC}{91}{Evaluated for Keywords, and handled accordingly. Message Body is parsed}
	\messageType{RENDER_MODULE}{92}{Forwarded to all other renderers by the server}
	\messageType{FEEDBACK}{93}{Messages from Renderer sent to a module. Message is parsed and sent to the specified module}
	...
	\messageType{UPDATE_LOADED_MAPNAME}{128}{Relayed to all Userinterface types, MAKRO (''UPDATE\_LOADED\_MAPNAME'') executed}
	...
	\messageType{NEW_UI}{142}{Processed and handled by server. Seems to request current collaborative state or list of partners, depending on parameters}
