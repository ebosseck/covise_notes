...
\begin{messagetypes}
	...
	\rowcolor{magenta!50!}\messageType{VRB_CURRENT_FILE}{107}{\color{green}\textbf{!!! DEPRECATED !!! DO NOT USE !!!}\color{black}, use \lstinline|COVISE_MESSAGE_VRB_REQUEST _FILE| and sharedState \lstinline|coVRFileManager_filePaths| instead. Should write to standard error, then abort execution. (See kernel/vrb/server/VrbMessageHandler.cpp)}
